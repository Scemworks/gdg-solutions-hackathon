            ...
            <div className="container mx-auto px-4 py-4 flex justify-between items-center">
                ...
                <div className="hidden md:flex items-center">
                    <nav className="flex space-x-4 mr-4">
                        ...
                        <Link href="/pollution-map" className={`text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 ${pathname === '/pollution-map' ? 'text-blue-600 dark:text-blue-400 font-semibold underline' : ''}`}>Map</Link>
                ...
                >
                    <div className="container mx-auto px-4">
                        <nav className="py-3 space-y-3">
                            ...
                            <Link href="/pollution-map" className={`block text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 ${pathname === '/pollution-map' ? 'text-blue-600 dark:text-blue-400 font-semibold underline' : ''}`}>Map</Link>
