...
export default function PollutionMap() {
    ...
    // Fetch AQI data and handle user location
    useEffect(() => {
        const fetchAllData = async () => {
            ...
            try {
                ...
                if (navigator.geolocation) {
                    navigator.geolocation.getCurrentPosition(
                        position => {
                            ...
                            // Add user's location to the sample locations
                            locationsToQuery.unshift({
                                lat: userLat,
                                lon: userLon,
                                name: "Your Location"
                            });
                ...
                // Fetch all data at once using the map endpoint
                const results = await fetchAQIMapData(locationsToQuery);
                setAqiData(results);
            } catch (err) {
